...
describe('OptimizedBadge', () => {
  ...
  it('says the settings are applied, when, and that it is not Examined', () => {
    ...
    expect(title).toContain('Not the same as Examined')
  })
...
describe('VerifiedBadge', () => {
  it('explains that Examined is about reviewed content, not settings', () => {
    render(<VerifiedBadge />)
    const title = screen.getByText('Examined').closest('span')!.getAttribute('title')!
    expect(title).toContain('examiner reviewed')
