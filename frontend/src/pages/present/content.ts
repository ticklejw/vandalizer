...
const team: Track = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Collect documents, URLs, and notes into a reusable knowledge base that becomes searchable context for chat. Keep it personal or share it with your team; examiners can publish reviewed knowledge bases to a shared catalog for everyone.',
    },
    {
      id: 'chat',
